...
public class GestionPersonnel implements Serializable
{
	...
	private static SortedSet<Ligue> ligues;
	
	private static Employe root;
	...
	public void setRoot(int id_employe, String nom, String prenom, String mail, String password){
		root = new Employe(id_employe,null,nom,prenom,mail,password);
	}
